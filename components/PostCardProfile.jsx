...
const PostCardProfile = ({ post }) => (
  <>
    <Link href={`/post/${post.slug}`}>
      <div className="bg-white interactable dark:bg-onbg-color-dk custom_bg_shadow rounded-lg dark:shadow-none p-3 lg:p-5 pb-8 lg:pb-12 mb-2 outline outline-2 dark:outline-0 outline-gray-300 minimal_border cursor-pointer">

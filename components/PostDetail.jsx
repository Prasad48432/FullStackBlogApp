    ...
    <motion.div initial="hidden" animate="visible"
      ...
      <div className="bg-white dark:bg-[#182a46] lg:shadow-lg rounded-lg lg:p-8 pb-12 mb-8">
        <div className="relative overflow-hidden lg:custom_bg_shadow mb-6">
          <img src={post.featuredImage.url} alt="" className="object-top h-full w-full object-cover dark:opacity-90 shadow-lg rounded-t-lg lg:rounded-lg" />
        </div>
        <div className="px-4 lg:px-0">
          <div className="flex items-center mb-8 w-full">
            ...
            <div className="font-medium text-gray-700 dark:text-[#3b8e8a]">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 inline mr-2 text-[#50c1bb]" fill="none" viewBox="0 0 24 24" stroke="currentColor">

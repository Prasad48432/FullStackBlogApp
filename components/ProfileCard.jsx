          ...
          <div className="flex flex-col pt-4 mx-auto my-auto sm:pt-0 sm:mx-0">
            ...
            <div className="flex items-center justify-center mt-3 space-x-2">
              <div className="flex">
                ...
                <span class="bg-blue-100 text-blue-800 text-xs font-medium ml-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-blue-400 border border-blue-400">{props.data.class}</span>
              </div>
            </div>
          </div>
        </div>

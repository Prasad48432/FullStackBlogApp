...
const Instagram = () => {
  return (
    <div className='max-w-[1240px] mx-auto text-center py-24'>
        ...
        <p className='pb-4 hover:underline text-grsy-900 dark:text-variant-color-dk decoration-sky-500 dark:decoration-gray-400 ease-in duration-100'><a href='https://www.instagram.com/vbit.stutalk/' target="_blank" rel="noreferrer">@vbit.stutalk</a></p>

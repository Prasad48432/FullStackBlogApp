  ...
  return (
    <>
      <footer
        ...
        className="bg-white dark:bg-bg-color-dk lg:grid lg:grid-cols-5 outline outline-2 outline-black dark:outline-variant-color-dk"
      >
        <div className="relative block lg:h-32 lg:col-span-2 rounded-lg">
          <h1 className="text-2xl text-center p-3 mt-3 font-semibold">
            Our{" "}
          ...
          <div className="grid grid-cols-3 gap-3 p-5">
            <div className="transition relative outline outline-1 outline-black dark:outline-variant-color-dk footer_magazine">
        ...
        <div className="px-4 py-8 sm:px-6 lg:col-span-3 lg:px-8">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                <p className="font-medium text-gray-900 dark:text-variant-color-dk">
                  Links
                </p>
